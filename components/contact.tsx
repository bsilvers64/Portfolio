    ...
    >
      ...
      >
        <input
          type="email"
          name="senderEmail"
          className="px-4 h-14 rounded-lg borderBlack dark:bg-white dark:bg-opacity-80 
            dark:focus:bg-opacity-100 transition-all dark:placeholder:text-black/60 dark:outline-none"
